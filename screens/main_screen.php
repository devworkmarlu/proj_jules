...
$userData = $sessionHandler->getSessionDetails();
$globalIP = GLOBAL_IP;
...
<html
  ...
  <head>
    <?php 
       include '../components/plugin_header.php';
    ?>
  </head>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        <!-- Menu -->
        <?php 
            include '../components/site_menu.php';
        ?>
        <!-- / Menu -->
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div id="in_app_content_container" class="container-xxl flex-grow-1 container-p-y">
              <!-- Content Container -->
    ...
    <?php 
        include '../components/plugin_footer.php';
    ?>
