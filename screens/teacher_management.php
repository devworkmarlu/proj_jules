...
<div class = "p-3" id = "operations_container">
    <span><button class = "btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add Teacher</button></span>
</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button onclick = "javascript:actionButton('adduser');" type="button" class="btn btn-primary">Add Teacher</button>
      </div>
    </div>
  </div>
</div>
<script>
    ...
    function loadData(){
        ...
        type:'POST',
        data:{purpose:'getallfaculty',parameters:'teacher'}
        ...
        if(res.error==false){
            ...
            $.each(res.user_data,function(i,val){
                ...
                <button onclick = "" class = "btn btn-sm btn-primary m-1">View Logs</button>
                <button onclick = "" class = "btn btn-sm btn-primary m-1">Add to class</button>
                ...
                tempData.push([count,val.full_name,val.username,hash,actionButtons]);
            });
